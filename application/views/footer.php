                    ...
                    <div class="col-lg-3 col-md-3"><!-- widgets column left -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                            ...
                            <li class="widget-container widget_nav_menu"><!-- widgets list -->
                                ...
                                <h1 class="title-widget" id="office-hour">OFFICE HOURS</h1>
                                <p class="footer-p-wht">
                                ...
                                <ul class="footerli">
                                    <h1 class="title-widget mt-30">OUR POLICIES</h1>

                                    <li><a href="<?php echo site_url('privacy-policy');?>">privacy policy</a></li>
                                    <li><a href="<?php echo site_url('terms-conditions');?>">terms and conditions</a></li>
                                    <li><a href="<?php echo site_url('complaints-procedure');?>">complaints procedure</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="copyright">
                            ...
                            <p class="footer-rght-align">Design & Developed By<a target="_blank" href="http://doodlodesigns.com/"> Doodlo Design Studio</a></p>
