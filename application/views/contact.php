...
<html lang="en">
    ...
    <head>
        ...
        <title>Phoenix R&D: Contact</title>
...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        ...
        {
           #footer-p-blue,#footer-p-wht,.span-text
           {
    ...
    <body>
        ...
        <section id="home" class="contact-1">
            <div class="container">
                <!--<div class="row align-items-center">-->
                    <div class="col-lg-5 col-md-5 col-sm-12 mt-lg-0 mt-4 contact-icons" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="500">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 text-lg-left text-center" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1500">
                        ...
                        <?php echo form_open('Home/submit_form', ['class' => "ml-mob-0 p-4"]); ?>
                            <h2 class="contact-heading-2 mt-30 ml-4">Schedule a Call</h2>
