...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <body>
        ...
        <section id="home" class="rnd-faq-4 header-margin">
            <div class="container">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
              ...
              <div class="panel panel-default no-border">
                ...
                <div id="process2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
                  <div class="panel-body">
                    <p class="footer-p-blue">R&D can take place in any sector and therefore a lot of SMEs miss out on claiming their grants. If you are a company that invests in an attempt to advance scientific or technological products, services or processes, then you are halfway there.</p>
                  </div>
                </div>
              </div>
              <div class="panel panel-default no-border">
                <div class="panel-heading" role="tab" id="heading3">
                  <h4 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#process3" aria-expanded="false" aria-controls="process3">
                      Am I eligible to claim to R&D?
                    </a>
                  </h4>
                </div>
                <div id="process3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3">
                  <div class="panel-body">
                    <p class="footer-p-blue">A number of factors, set by HMRC, are required for any business claiming R&D tax credits. Our quick and easy tools can help you find your eligibility and identify qualifying expenditure and enhance it by the relevant rate.</p>
                  </div>
                </div>
              </div>
              <div class="panel panel-default no-border">
                ...
                <div id="process4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4">
                  <div class="panel-body">
                    <p class="footer-p-blue">Having worked with HMRC for many years, our team of chartered tax advisors have an extensive knowledge of R&D Grants and criteria of HMRC. We ensure that we save your time by preparing qualifying reports from technical and financial data for a successful application.</p>
                  </div>
                </div>
              </div>
              <div class="panel panel-default no-border">
                ...
                <div id="process5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
                  <div class="panel-body">
                      <ul class="accordian-list">
                          <li>We know that every business is different, therefore, we ensure to find, evaluate and document your research activities. Our team of analysts will chat with you about your potential qualifying R&D activities and how we will work together.</li>
                          <li>Our next step would be to generate a claim report, that consists of your technical and financial evidence, and the processes involved in the creation of your product or service.</li>
                          <li>Once all your relevant documents have been compiled, we submit your claim to HMRC on your behalf.  Our prior experience and relationship with HMRC would ensure that your business receives maximum benefits.</li>
                          <li>Our dedicated team maintains regular communication to make sure that we keep you updated on the progress. Depending on your case, the claim is expected to be received within weeks of submission.</li>
                      </ul>
                </div>
                </div>
              </div>
              <div class="panel panel-default no-border">
                <div class="panel-heading" role="tab" id="heading6">
                  <h4 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#process6" aria-expanded="false" aria-controls="process6">
                      How much can I claim?
                    </a>
                  </h4>
                </div>
                <div id="process6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
                  <div class="panel-body">
                    <p class="footer-p-blue">The amount of grant you receive depends on company size, case, and the schemes you qualify for. SMEs can claim anywhere between 14-33% on any costs which qualify.</p>
                  </div>
                </div>
              </div>
              <div class="panel panel-default no-border">
                <div class="panel-heading" role="tab" id="heading7">
                  <h4 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#process7" aria-expanded="false" aria-controls="process7">
                      Can I claim for failed projects?
                    </a>
                  </h4>
                </div>
                <div id="process7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading7">
                  <div class="panel-body">
                    <p class="footer-p-blue">Yes! As a form of innovation funding, R&D tax credits can be claimed for failed or unfinished projects. Also, even loss making companies could be eligible to apply for a grant.</p>
                  </div>
                </div>
              </div>
            </div>
